...
const addToBasket = (e) => {
	...
	const basketTotal = basket.reduce((sum, product) => {
		return (sum += product.price - (product.saleAmont ?? 0));
	}, 0);
...
// Funnkcja renderowania produktów przy każdym przeładowaniu strony
...
// Dodawanie do koszyka przy zmianie kategorii
...
// Funkcja renderowania kategorii
